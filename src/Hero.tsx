    ...
    return (
        <div id='hero' className='relative w-full h-full p-20 py-32 sm:py-64 flex flex-col gap-4 sm:gap-12 text-center items-center overflow-hidden'>
            ...
            <div className='z-40 flex gap-4'>
                <button className='leading-5 border border-gray-800/50 w-32 p-2 rounded-lg bg-amber-600 text-sky-100'>Agendar Salto</button>
                <button className='leading-5 border border-gray-800/50 w-32 p-2 rounded-lg bg-amber-600 text-sky-100'>Saber Mais</button>
            </div>

            <video className='z-30 absolute top-0 left-0 w-full h-full scale-[2]' autoPlay muted loop src="/assets/video/sky-peaceful.mp4"></video>
