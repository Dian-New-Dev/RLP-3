...
const [contador, setContador] = useState(1);
    ...
    const src = `./assets/img/galeria${numeroDoSrc}.jpg`
    ...
    return (
        <div id='D' className='z-10 text-sky-100 font-bold p-8 flex flex-col gap-8 lg:gap-32 mx-auto'>
            <div id='h3' className='z-10 flex relative border-b-4 border-l-4 px-4 py-4 border-amber-600 items-start w-44 scale-100 lg:scale-150 origin-top-left'>
                ...
                <img className='z-10 absolute w-[80px] pl-[20px] opacity-100 bottom-[10px] left-[90px]' src={"./assets/img/plane.svg"} alt="Imagem de fundo na forma de um avião" />
            </div>
            ...
            <div className='z-10 w-full max-w-[600px] p-1 bg-amber-600 rounded-lg mx-auto esconder-scrollbar'>
                ...
                <div className='z-10 flex h-full'>
                    <div className='z-10 flex items-center gap-2 p-2 w-1/2  bg-gray-700 text-sky-100 font-normal'>
                        <img className='z-10 w-[25px] h-[30px]' src={"./assets/img/imagem.png"} alt="Ícone de fotos" />
