...
const Sobre: React.FC = () => {
    return (
        <div id='B' className=' text-sky-100 p-8 lg:p-16 flex flex-col gap-16 lg:gap-32'>
            <div id='h3' className='flex relative border-b-4 border-l-4 px-4 py-4 border-amber-600 items-start w-44 font-bold scale-100 lg:scale-150 origin-top-left'>
                ...
                <img className='absolute w-[80px] pl-[20px] z-0 opacity-100 bottom-4 left-[90px]' src={"./assets/img/plane.svg"} alt="Imagem de fundo na forma de um avião" />
            </div>
