...
const Modalidades: React.FC = () => {
    return (
        <div id='modalidades' className='z-10 text-sky-100 p-8 lg:p-16 flex flex-col gap-16 lg:gap-32 border border-gray-900 bg-gray-700/75 m-4 rounded-3xl'>
            ...
            <div id="modalidades-flexbox" className='z-10 flex flex-col lg:flex-row lg:justify-center gap-16'>
                <div className='z-10 flex flex-col gap-2 lg:gap-8'>
                    <div className='z-10 flex items-center gap-4'>
                        <img className='z-10 w-[50px] h-[50px] bg-amber-600 rounded-full p-2' src="public/assets/img/tandem.png" alt="Ícone de salto tandem" />
                        <h4 className='z-10 text-lg lg:text-2xl font-bold'>Salto Tandem</h4>
                    </div>
                ...
                <div className='z-10 flex flex-col gap-2 lg:gap-8'>
                    <div className='z-10 flex items-center gap-4'>
                        <img className='z-10 w-[50px] bg-amber-600 rounded-full p-2' src="public/assets/img/solo.png" alt="Ícone de salto solo" />
                ...
                <div className='z-10 flex flex-col gap-2 lg:gap-8'>
                    <div className='z-10 flex items-center gap-4'>
                        <img className='z-10 w-[50px] lg:w-[75px] bg-amber-600 rounded-full p-2' src="public/assets/img/grupo.png" alt="Ícone de salto em grupo" />
                        <h4 className='z-10 text-lg lg:text-2xl font-bold'>Salto em Formação</h4>
                    </div>
            ...
            <button className='z-10 leading-5 border border-gray-800/50 w-32 p-2 rounded-lg bg-amber-600 text-sky-100 mt-0 lg:mt-[-50px]'>Qual devo escolher?</button>
            </div>
        </div>
    )
