    ...
    return (
        <div id='C' className='z-10 text-sky-100 p-8 lg:p-16 flex flex-col gap-16 lg:gap-32 border border-gray-900 bg-gray-700/75 m-4 rounded-3xl'>
            <div id='h3' className='z-10 flex relative border-b-4 border-l-4 px-4 py-4 border-amber-600 items-start w-44 scale-100 lg:scale-150 origin-top-left'>
                ...
                <img className='z-10 border-b-4 absolute w-[80px] pl-[20px] border-amber-600 opacity-100 top-1 left-[170px]' src={"./assets/img/plane.svg"} alt="Imagem de fundo na forma de um avião" />
            </div>
            ...
            <div id="modalidades-flexbox" className='z-10 flex flex-col lg:flex-row lg:justify-center gap-16'>
                <div className='z-10 flex flex-col gap-2 lg:gap-8 p-6 hover:shadow-2xl hover:scale-110 hover:bg-gray-700 rounded-3xl'>
                    <div className='z-10 flex items-center gap-4'>
                        <img className='z-10 w-[50px] h-[50px] bg-amber-600 rounded-full' src={"./assets/img/salto-tandem.png"} alt="Ícone de salto tandem" />
                ...
                <div className='z-10 flex flex-col gap-2 lg:gap-8 p-6 hover:shadow-2xl hover:scale-110 hover:bg-gray-700 rounded-3xl'>
                    <div className='z-10 flex items-center gap-4'>
                        <img className='z-10 w-[50px] bg-amber-600 rounded-full' src={"./assets/img/salto-solo.png"} alt="Ícone de salto solo" />
                ...
                <div className='z-10 flex flex-col gap-2 lg:gap-8 p-6 hover:shadow-2xl hover:scale-110 hover:bg-gray-700 rounded-3xl'>
                    <div className='z-10 flex items-center gap-4'>
                        <img className='z-10 w-[50px] bg-amber-600 rounded-full' src={"./assets/img/salto-grupo.png"} alt="Ícone de salto em grupo" />
